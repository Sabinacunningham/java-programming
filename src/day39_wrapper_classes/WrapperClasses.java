...
public class WrapperClasses {
    public static void main(String[] args) {
        ...
        Integer n2 = 1000; //number is 1000 integer whole number
        System.out.println(n2 / 50);
        //convert n2 to String is to concatnate with empty string. Once it becomes string you can continue;
        String numStr = n2 + ""; // this is a string
