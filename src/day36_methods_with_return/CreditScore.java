...
public class CreditScore {
    public static void main(String[] args) {
        ...
        int score = getCreditScore(); //store in variable
    ...
    public static void checkEligible(int creditScore) { //takes one input
        if (creditScore >= 700) {
            System.out.println("You are eligible for leasing this car");
        } else {
            System.out.println("Sorry, you are not eligible to lease car");
        }
