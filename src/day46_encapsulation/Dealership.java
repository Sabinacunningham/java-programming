...
public class Dealership { //dealership is separate class
    public static void main(String[] args) {
        Car car1 = new Car();
        //ERROR below, model and year are PRIVATE and cannot be accessed from a different class
        //car1.model = "Nissan Altima";
        //car1.year = 2020; cannot read or give some data
        car1.setModel("Nissan Altima"); //private String model;
        ...
        System.out.println(alfaRomeo); //prints the entire thing calls to STring
